...
doc_content_list = []
f = open('../../data/corpus/covid_19_production.txt', 'rb')
...
corp_vocab = []
vocab_path = 'corpus/covid_19_production.treebank.bio_vocab.txt'
...
model = BertForSequenceClassification.from_pretrained(
    '../../TextSGC_Bio/data/tuned_biobert_covid', # use the already trained model, just further train now.
