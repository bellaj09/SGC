...
if args.tuned:
    with open("tuned_result/{}.SGC_bio.tuning.txt".format(args.dataset), "r") as f:
...
if __name__ == '__main__':
    ...
    test_res_file = open("results/{}.SGC_bio.results.txt".format(args.dataset), 'w')
    printing = test_matrix.cpu().numpy()
    np.savetxt("results/{}.SGC_bio.results.txt".format(args.dataset),printing)
    test_res_file.close()