...
data = pd.read_csv('data/ohsumed_xlnet.csv')
data.head()

sentences = data.texts.to_list()
...
tokenizer = XLNetTokenizer(vocab_file=vocabulary,do_lower_case=False) # cased model so do_lower_case = False
...
## Save model
xlnet_out_address = 'models/xlnet_out'
